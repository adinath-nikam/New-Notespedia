...
public class Profile extends AppCompatActivity {
    ...
    TextView ProfileHeaderName,ProfileHeaderEmail,ProfileName,ProfileEmail,ProfileGender,ProfilePhone,ProfileDepartment,ProfileSemester,ProfileCollege;
    ...
    String ProfileNameVAR,ProfileEmailVAR,ProfilePhoneVAR,ProfileGenderVAR,ProfileDepartmentVAR,ProfileSemesterVAR,ProfileCollegeVAR;
            ...
            public void onClick(View v) {
                ...
                UpdateDepartmentADB.setSingleChoiceItems(values, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        {
                            case 0:
                                SendDataDB UpdateDeptToCS = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR, ProfileGenderVAR, "COMPUTER SCIENCE AND ENGINEERING",ProfileSemesterVAR,ProfileCollegeVAR);
                                mRef.setValue(UpdateDeptToCS);
                                break;
                            case 1:
                                    SendDataDB UpdateDeptToME = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR, ProfileGenderVAR, "MECHANICAL ENGINEERING",ProfileSemesterVAR,ProfileCollegeVAR);
                                mRef.setValue(UpdateDeptToME);
                                break;
                            case 2:
                                SendDataDB UpdateDeptToAT = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR, ProfileGenderVAR, "AUTOMOBILE ENGINEERING",ProfileSemesterVAR,ProfileCollegeVAR);
                                mRef.setValue(UpdateDeptToAT);
                                break;
                            case 3:
                                SendDataDB UpdateDeptToEC = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR, ProfileGenderVAR, "ELECTRONICS AND COMMUNICATION ENGINEERING",ProfileSemesterVAR,ProfileCollegeVAR);
                                mRef.setValue(UpdateDeptToEC);
                                break;
                            case 4:
                                SendDataDB UpdateDeptToEE = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR, ProfileGenderVAR, "ELECTRICAL AND ELECTRONICS ENGINEERING",ProfileSemesterVAR,ProfileCollegeVAR);
                ...
                UpdateGenderADB.setSingleChoiceItems(Gendervalues, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        switch(item)
                        {
                            case 0:
                                progressDialog.show();
                                SendDataDB UpdateGenderToMale = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR,"Male", ProfileDepartmentVAR,ProfileSemesterVAR,ProfileCollegeVAR);
                            ...
                            case 1:
                                progressDialog.show();
                                SendDataDB UpdateGenderToFemale = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR, "Female",ProfileDepartmentVAR,ProfileSemesterVAR,ProfileCollegeVAR);
                ...
                UpdatePhoneADB.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (newPhone.length() < 10 || newPhone.length() > 10) {
                            ...
                            SendDataDB UpdateData = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, newPhone, ProfileGenderVAR, ProfileDepartmentVAR,ProfileSemesterVAR,ProfileCollegeVAR);
                            ...
                            CurrentUser.updateEmail(newEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        SendDataDB UpdateData = new SendDataDB(ProfileNameVAR, newEmail, ProfilePhoneVAR, ProfileGenderVAR, ProfileDepartmentVAR,ProfileSemesterVAR,ProfileCollegeVAR);
                                        mRef.setValue(UpdateData);
                ...
                UpdateNameADB.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (newUsername.isEmpty()) {
                            ...
                            SendDataDB UpdateData = new SendDataDB(newUsername, ProfileEmailVAR, ProfilePhoneVAR, ProfileGenderVAR, ProfileDepartmentVAR,ProfileSemesterVAR,ProfileCollegeVAR);
                            mRef.setValue(UpdateData);
    ...
    private void GetDatabaseValuesToVariables() {
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ProfileCollegeVAR = userProfile.getUserCollege();
                progressDialog.dismiss();
    ...
    public void CastingViews() {
        ...
        ProfileCollege = findViewById(R.id.profile_college);
                ...
                UpdateSemesterADB.setSingleChoiceItems(Semstervalues, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        switch(item)
                        {
                            case 0:
                                progressDialog.show();
                                SendDataDB UpdateSemesterTo1 = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR,ProfileGenderVAR, ProfileDepartmentVAR,"1ST SEMESTER",ProfileCollegeVAR);
                            ...
                            case 1:
                                progressDialog.show();
                                SendDataDB UpdateSemesterTo2 = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR,ProfileGenderVAR, ProfileDepartmentVAR,"2ND SEMESTER",ProfileCollegeVAR);
                            ...
                            case 2:
                                progressDialog.show();
                                SendDataDB UpdateSemesterTo3 = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR,ProfileGenderVAR, ProfileDepartmentVAR,"3RD SEMESTER",ProfileCollegeVAR);
                            ...
                            case 3:
                                progressDialog.show();
                                SendDataDB UpdateSemesterTo4 = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR,ProfileGenderVAR, ProfileDepartmentVAR,"4TH SEMESTER",ProfileCollegeVAR);
                            ...
                            case 4:
                                progressDialog.show();
                                SendDataDB UpdateSemesterTo5 = new SendDataDB(ProfileNameVAR, ProfileEmailVAR, ProfilePhoneVAR,ProfileGenderVAR, ProfileDepartmentVAR,"5TH SEMESTER",ProfileCollegeVAR);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(Profile.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(Profile.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
                        }
                    })
